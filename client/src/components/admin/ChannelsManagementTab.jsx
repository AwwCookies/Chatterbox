...
function ChannelsManagementTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm">Add, remove, and manage monitored Twitch channels</p>
      </div>

      {/* Add Channel */}
      <div className="bg-twitch-dark rounded-lg p-4 border border-gray-700">
        ...
        <form onSubmit={handleAddChannel} className="flex gap-3">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full bg-twitch-gray border border-gray-600 rounded-md py-2 pl-10 pr-4 text-white placeholder-gray-400 focus:outline-none focus:border-twitch-purple"
            />
          </div>
          <button
            type="submit"
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-twitch-dark rounded-lg p-4 border border-gray-700">
          <div className="text-2xl font-bold text-green-400">{activeChannels.length}</div>
          <div className="text-sm text-gray-400">Active</div>
        </div>
        <div className="bg-twitch-dark rounded-lg p-4 border border-gray-700">
          <div className="text-2xl font-bold text-gray-400">{inactiveChannels.length}</div>
          <div className="text-sm text-gray-400">Inactive</div>
        </div>
      </div>

      {/* Active Channels */}
      <div className="bg-twitch-dark rounded-lg border border-gray-700">
...
export default ChannelsManagementTab;
